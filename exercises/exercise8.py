...
compra1 = ["cafetera", "TV 50 pulgadas", "mouse gamer"]
compra2 = ["ipad", "ipod", "iphone"]
compra3 = ["Reproductor de CD", "Videograbadora"]

Compras = {"Mario Pedernera": compra1,
           "Ezequiel Castello": compra2,
           "Pablo Piristrelli": compra3
           }
